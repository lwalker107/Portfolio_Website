...
const Hero = () => {
  return (
    ...
    h-screen mx-auto">
      ...
      absolute inset-0 top-[120px] max-w-7x1 mx-auto flex 
      flex-row items-start gap-5`}>
        ...
        <div>
          ...
          text-white`}>Hi, my name is <span 
          className="text-[#915eff]">Landen
          </span></h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I am a fullstack web developer <br 
            className="sm:block hidden" /> with a drive to push myself
