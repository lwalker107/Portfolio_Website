...
import { logo, logo3, menu, close } from '../assets';
      ...
      items-center max-w-7xl mx-auto">
        <Link
          ...
          onClick={() => {
            ...
            <p className="text-white text-[18px] font-bold cursor-pointer flex"> Landen <span className="sm:
            block hidden">| Portfolio</span></p>
        </Link>
